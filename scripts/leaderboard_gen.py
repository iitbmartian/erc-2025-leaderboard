  ...
  <div class="overlay">
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col items-center mb-6">
          ...
          <h1 class="text-5xl font-bold glow text-center text-gray-800">Live Leaderboard</h1>
        </div>
...
if __name__ == "__main__":
    ...
    rounds = [
            ...
            (4, "Payload Test",
             ...
             "Team","Payload Test"),
            (5, "Challenge Test",
             "https://raw.githubusercontent.com/husarion/erc2025/refs/heads/main/phase_4/demo_results.md",
             "Team","Sum (0-100)"),
            (6, "Report",
             "https://raw.githubusercontent.com/husarion/erc2025/refs/heads/main/phase_6/challenge_2_reports.md",
             "Team","Challenge 2"),
            (7, "Jury Points",
